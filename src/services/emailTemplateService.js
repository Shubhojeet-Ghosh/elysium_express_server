                ...
                <table width="100%" style="background:#fff;max-width:600px;margin:40px auto 0 auto;padding:30px 0 30px 0;border-radius:12px;box-shadow:0 2px 8px #eee;">
                  <tr>
                    <td style="padding:32px 32px 16px 32px;text-align:left;">
                      <h2 style="margin:0 0 8px 0; color:#0E1F2F; font-size:20px;">Hey there!</h2>
                      <p style="margin:0; color:#222; font-size:16px; font-weight:600;">
                        Welcome to <span style="color:#00879e;">Elysium<span style="color:#0E1F2F;">Chat</span></span>
                      </p>
                      <p style="margin:24px 0 0 0; color:#666; font-size:15px;">
                        We received a request to log in to your account associated with 
                        <span style="color:#86A6CF; font-weight:bold;">${email}</span>.<br/>
                        Click the button below to securely log in.<br/>
                        <b style="color:#0E1F2F;">This link is valid for ${expiresIn} minutes only.</b>
                      </p>
                      <div style="margin:32px 0; text-align:center;">
                        <a href="${magicLink}"
                           style="background:#0E1F2F;color:#fff;padding:10px 20px;border-radius:7px;text-decoration:none;
                                  font-size:13px;font-weight:600;letter-spacing:0.5px;box-shadow:0 1px 4px #eee;
                                  display:inline-block;min-width:120px;max-width:240px;">
                          Log in...
                        </a>
                      </div>
                      <div style="margin-bottom:18px;text-align:center;">
                        ...
                        <a href="${magicLink}" style="color:#86A6CF;word-break:break-all;font-size:13px;">
                          ${magicLink}
                        </a>
                      </div>
                      ...
                      <div style="border-top:1px solid #eee; margin-top:24px; padding-top:12px;">
                        <span style="color:#aaa;font-size:12px;">
                          Need help? 
                          <a href="mailto:shubhojeet.official@gmail.com" style="color:#0E1F2F;text-decoration:underline;">Contact Support</a>
                        </span>
                      </div>
                    </td>
                  </tr>
